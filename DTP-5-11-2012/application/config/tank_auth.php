...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Ditch the Pitch';
$config['webmaster_email'] = 'phil@ditchthepitch.com.au';//'anilmomin87@gmail.com';
...
$config['recaptcha_public_key'] = '6Le798kSAAAAAHQFgAhV6UV-i0Nm_r8N-hVqyaAu';
$config['recaptcha_private_key'] = '6Le798kSAAAAAFGY7PgT57vOartz8bVXG-MyRbxA';
