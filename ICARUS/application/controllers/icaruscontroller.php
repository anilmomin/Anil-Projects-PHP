...
class IcarusController extends Controller
{
	...
	public function __construct()
	{
		...
		//$this->session->keep_flashdata('selCourse');

		//echo "Got the course code as : " . $this->session->flashdata('selCourse') . "<br>";
	}
	...
	{
		if (!$this->setCourseCalled)
		{
			$this->session->keep_flashdata('selCourse');
		}

		$this->headerData['selCourse'] = $this->selectedCourse;
	...
	{
		return $this->session->flashdata('selCourse');
	}

	protected function setSelectedCourse($courseCode)
	{
		$this->session->set_flashdata('selCourse', $courseCode);
		$this->selectedCourse = $courseCode;
		$this->setCourseCalled = true;
	}
}
