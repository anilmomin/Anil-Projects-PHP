...
/**	This is the persistence class for the quiz_ans table of database.	*/
class QuizQsOptions extends IcarusModel
{
	/**
	...
	{
		parent::__construct();
		$this->tableName = TABLE_QUIZ_QS_OPTIONS;
		$this->addPrimaryKey('quesId');
		$this->addPrimaryKey('qsOptionNo');
	}
}
